    ...
    <div style={{ background: C.bg, color: "#fafafa", fontFamily: "system-ui, -apple-system, sans-serif", minWidth: 0, overflowX: "hidden" }}>
      ...
      <section id="pricing" style={{ ...sectionStyle, padding: "64px 24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 12 }}>
          {[
            { name: "Open Source", price: "Free", period: "forever", sub: "You run the infrastructure", key: "free", features: ["Full Python + TypeScript SDK", "Deploy to your own Railway", "Your own Supabase + Mem0", "1,000 runs/month on your infra", "Unlimited agent types", "No AI Cop analysis", "Community support on GitHub"], cta: "View self-hosting guide \u2192", pop: false, link: "/docs/self-hosting" },
            { name: "Cloud Solo", price: "$29", period: "/mo", sub: "We run everything for you", key: "solo", features: ["Zero setup \u2014 2 lines of code", "Our Railway, Supabase, Mem0, Langfuse", "10,000 runs/month included", "5 agent types", "AI Cop analysis on every run", "Email support from Dharma directly"], cta: "Start Trial", pop: true },
            { name: "Cloud Teams", price: "$99", period: "/mo", sub: "We run everything, for your team", key: "teams", features: ["Everything in Solo", "50,000 runs/month included", "Unlimited agent types", "10 team member logins", "Mission Control for whole team", "Drift detection + pattern alerts", "Priority support"], cta: "Start Trial", pop: false },
            { name: "Enterprise", price: "Custom", period: "", sub: "Your infrastructure or ours", key: "enterprise", features: ["Unlimited runs/month", "Unlimited agent types", "Dedicated Railway deployment", "HIPAA \u00B7 FERPA \u00B7 COPPA compliance", "SSO + full audit trail", "Custom data retention policies", "SLA with guaranteed uptime"], cta: "Contact Sales", pop: false },
          ].map(plan => (

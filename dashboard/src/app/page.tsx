      ...
      <section id="pricing" style={{ ...sectionStyle, padding: "64px 24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 12 }}>
          {[
            ...
            { name: "Cloud Solo", price: "$29", period: "/mo", sub: "We run everything for you", key: "solo", features: ["Zero setup \u2014 2 lines of code", "Our Railway, Supabase, Mem0, Langfuse", "10,000 runs/month included", "5 agent types", "AI Cop analysis on every run", "Email support from Dharma directly"], cta: "Get Started", pop: true },
            { name: "Cloud Teams", price: "$99", period: "/mo", sub: "We run everything, for your team", key: "teams", features: ["Everything in Solo", "50,000 runs/month included", "Unlimited agent types", "10 team member logins", "Mission Control for whole team", "Drift detection + pattern alerts", "Priority support"], cta: "Get Started", pop: false },
